...
//! | 24/25 | AIDMAADDR  | AI DMA address (shared with dkdol-hal::ai)        |
...
///
/// # Safety
/// Call once during startup, after `dkdol_rt::exception::init()`.
pub unsafe fn init() {
...
/// Not part of the public API — called by `dkdol_rt::exception`.
#[no_mangle]
...
pub unsafe fn register_callback(cb: fn()) {
    let _guard = dkdol_rt::irq::disable();
