# TODO: dkdol-rt — Runtime (Remaining Work)
...
- [ ] **Handler registration API** — `dkdol_rt::exception::register(Exception::Dsi, my_handler)`
...
- [ ] **Critical sections** — `with_irq_disabled(|| { ... })` helper that saves and
  restores MSR[EE] around a closure. Used internally by dkdol-alloc and dkdol-hal drivers.
