...
//    any binary depending on `gc-rt` gets the correct linker script.
//
...
fn main() {
    ...
    // gc-rt lives at  <workspace>/crates/gc-rt/
    // workspace root is two levels up.
    let workspace_root = PathBuf::from(&manifest_dir)
        .parent()   // crates/
        .expect("gc-rt has no parent directory?")
    ...
    // This is propagated to any binary that has gc-rt as a (transitive) dependency.
    println!(
